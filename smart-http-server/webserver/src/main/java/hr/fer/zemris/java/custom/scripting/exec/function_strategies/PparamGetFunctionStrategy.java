 ...
 * persistent parameters. If such parameter does not exist a default value is pushed on stack.
 * @author Tomislav
 *
 */

public class PparamGetFunctionStrategy implements IFunctionStrategy {

...
/**
 * Class implements worker which task is to write "Hello" message, display a clock,
 * and display number of characters in name parameter if such parameter is received.
 * Finally worker sends that data as response to client.
 * @author Tomislav
 *
 */

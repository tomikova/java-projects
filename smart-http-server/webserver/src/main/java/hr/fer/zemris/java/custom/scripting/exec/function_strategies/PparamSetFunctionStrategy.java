...
/**
 * Class implements IFunctionStrategy and sets requestContext persistent parameter under
 * provided name to provided value.
 * @author Tomislav
 *
 */

public class PparamSetFunctionStrategy implements IFunctionStrategy {
